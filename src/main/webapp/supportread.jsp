                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="review-tab-pro-inner">
                                    <ul id="myTab3" class="tab-review-design">
                                        <li class="active"><a href="#description"><i class="icon nalika-edit" aria-hidden="true"></i>Message</a></li>
                                    </ul>
                                    <div id="myTabContent" class="tab-content custom-product-edit">
                                        <div class="product-tab-list tab-pane fade active in" id="description">
                                            <form action="SupportRead" method="post">
                                            <%
                                                ResultSet rs = (ResultSet) request.getAttribute("supportrequest");
                                                while (rs.next()) {
                                            %>
                                            <div class="row">
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <br>
                                                            <span style="color: white; "><%= rs.getString("full_name")%></span>
                                                        </div>
                                                        <hr>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <label style="color: white; ">Phone:</label>
                                                            <br>
                                                            <span style="color: white; "><%= rs.getString("phone")%></span>
                                                        </div>
                                                        <hr>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <label style="color: white; ">Gender:</label>
                                                            <br>
                                                            <span style="color: white; "><%= rs.getString("gender")%></span>
                                                        </div>
                                                        <hr>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <label style="color: white; ">Address:</label>
                                                            <br>
                                                            <span style="color: white; "><%= rs.getString("address")%></span>
                                                        </div>
                                                        <hr>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <label style="color: white; ">Time:</label>
                                                            <br>
                                                            <span style="color: white; "><%= rs.getDate("date_time")%></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt">
                                                            ...
                                                            <textarea rows="20" cols="80"><%= rs.getString("message_context")%></textarea>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                    <div class="text-right custom-pro-edt-ds">
                                                        <a href="SupportRead?id=<%= rs.getInt("account_id")%>"><button type="submit" name="btnReply" class="btn btn-ctl-bt waves-effect waves-light m-r-10">Reply</button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <%
