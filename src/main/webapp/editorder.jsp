                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt" style="display: none">
                                                            ...
                                                            <input type="text" class="form-control" name="o_id" value="${o.getOrderID()}"  readonly style="color: black">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt" style="display: none">
                                                            <span class="input-group-addon"><i class="icon nalika-edit" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control"  name="o_date" value="${o.getOrderDate()}"  readonly style="color: black">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt">
                                                            <span class="input-group-addon"><i class="icon nalika-favorites" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control" value="${o.getDeliveryDate()}" name="delivery_date" >
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                    <div class="review-content-section">
                                                        <div class="input-group mg-b-pro-edt" style="display: none">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="status" value="${o.getStatus()}" name="status"  readonly style="color: black">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt" style="display: none">
                                                            <span class="input-group-addon"><i class="icon nalika-new-file" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control" placeholder="note" name="note" value="${o.getNote()}" readonly style="color: black">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt" style="display: none">
                                                            <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control" placeholder="account_id" name="account_id" value="${o.getAccountID()}" readonly style="color: black">
                                                        </div>
                                                        <div class="input-group mg-b-pro-edt" style="display: none">
                                                            <span class="input-group-addon"><i class="icon nalika-favorites-button" aria-hidden="true"></i></span>
                                                            <input type="text" class="form-control" placeholder="account_id" name="address" value="${o.getAddress()}" readonly style="color: black">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
