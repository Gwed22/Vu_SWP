 ...
 * @author PC
 */
@WebFilter(filterName = "AdminFilter", urlPatterns = {"/admin", "/productlist", "/userlist", "/addproduct", "/productedit", "/orderlist", "/orderedit", "/profile","/adminlist"})
