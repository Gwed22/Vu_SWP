                    ...
                    <div class="card my-auto">
                        <form class="card-body cardbody-color p-lg-5" action="editprofile" method="post">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="answer"  value="${acc.getAnswer_context()}" name="txtAnswer" required="" readonly="">
                            </div>
                            <div class="text-center"><button type="submit" onclick="return check()" class="btn btn-color px-5 mb-5 w-100" name="btnUpdate">Edit</button></div>
                        </form>
                    </div>
                </div>
            </div>
